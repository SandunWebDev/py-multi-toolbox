...
import polygonHandler.polygon as shape_calculator
...
class UnitTests(unittest.TestCase):
    ...
    def test_area(self):
        ...
        expected = 18
        self.assertEqual(
            actual, expected, "Expected area of rectangle to be 18"
        )
    ...
    def test_perimeter(self):
        ...
        expected = 18
        self.assertEqual(
            actual, expected, "Expected perimeter of rectangle to be 18"
        )
        actual = self.sq.get_perimeter()
        expected = 20
        self.assertEqual(
            actual, expected, "Expected perimeter of square to be 20"
        )
    ...
    def test_square_picture(self):
        ...
        expected = "**\n**\n"
        self.assertEqual(
            actual, expected, "Expected square picture to be different."
        )
    ...
    def test_big_picture(self):
        ...
        self.assertEqual(
            actual, expected, 'Expected message: "Too big for picture."'
        )
    ...
    def test_get_amount_inside(self):
        ...
        expected = 6
        self.assertEqual(
            actual, expected, "Expected `get_amount_inside` to return 6."
        )
